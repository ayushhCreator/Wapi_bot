...
class VehicleExtractionSignature(dspy.Signature):
    ...
    brand: str = dspy.OutputField(desc="Vehicle brand (e.g., Tata, Honda, Mahindra)")
    model: str = dspy.OutputField(desc="Vehicle model (e.g., Nexon, City, Scorpio)")
    ...
    reasoning: str = dspy.OutputField(desc="Why these vehicle details were extracted")
